...
./walletd -w walletA.wallet -p yourpass --rpc-password test --daemon-port 7770 --bind-port 8070
./walletd -w walletB.wallet -p yourpass --rpc-password test --daemon-port 7770 --bind-port 8071
